...
- **Milestones**:
    ...
    - [ ] **TTS Client Mocking**: `tests/test_tts.py` - Mock the Google Cloud TTS client to test synthesis logic without burning credits.
    - [ ] **CLI Integration Tests**: `tests/test_cli.py` - Test the command-line interface using `typer.testing.CliRunner`.
